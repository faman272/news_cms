    ...
    return (
        <div className='py-28'>
            ...
            <section className='p-8 xl:p-16 bg-backgroundPrimary '>
                <div className='flex flex-col gap-8 md:flex-row md:justify-between xl:justify-between md:items-center 2xl:justify-center'>
                    ...
                    <div>
                        <div className='w-full max-w-[500px] md:max-w-[300px] lg:max-w-[400px] xl:max-w-[500px] h-auto'>
                            <img
                                src={imagePath}
                                alt="News Image"
                    ...
                    <div className='pt-6'>
                        {
                            news.categories.map((category, index) => {
                                return (
                                    <a key={index} href='' className='mr-2 font-semibold bg-primary30 text-primary text-xs xl:text-sm p-1.5 rounded-[6px]'>
                                        {category.name}
                                    </a>
                                )
                            })
